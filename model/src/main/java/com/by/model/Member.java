...
public class Member {
	...
	@OneToMany(mappedBy = "member", fetch = FetchType.LAZY)
	private List<ParkingCouponDetail> parkingCouponDetails;

	public List<ParkingCouponDetail> getParkingCouponDetails() {
		return parkingCouponDetails;
	}

	public void setParkingCouponDetails(List<ParkingCouponDetail> parkingCouponDetails) {
		this.parkingCouponDetails = parkingCouponDetails;
	}
