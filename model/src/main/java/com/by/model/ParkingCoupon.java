...
public class ParkingCoupon extends Coupon {
	...
	@OneToMany(mappedBy = "coupon", fetch = FetchType.LAZY)
	private List<ParkingCouponDetail> parkingMembers;

	public ParkingCoupon() {
		super();
	}

	public List<ParkingCouponDetail> getParkingMembers() {
		return parkingMembers;
	}

	public void setParkingMembers(List<ParkingCouponDetail> parkingMembers) {
		this.parkingMembers = parkingMembers;
	}
