...
public class ParkingCouponMemberServiceImpl implements ParkingCouponMemberService {
	...
	@Override
	@Transactional(readOnly = true)
	public Page<ParkingCouponMember> findByMemberPageable(Member member, Pageable pageable) {
		return repository.findByMemberAndValidPageable(member,ValidEnum.VALID,Calendar.getInstance(),pageable);
	}
