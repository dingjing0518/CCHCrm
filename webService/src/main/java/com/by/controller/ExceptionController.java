...
import com.by.json.MemberNotValidJson;
...
public class ExceptionController {
	...
	@ResponseBody
	public ResponseEntity<MemberNotValidJson> MemberNotValidException() {
		return new ResponseEntity<>(new MemberNotValidJson(getMessage("member.NotValidException"), false),
